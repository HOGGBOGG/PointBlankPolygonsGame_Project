...
public class AiSensoryMemory 
{
    ...
    {
        int targets = sensor.Filter(characters); // HOSTILE LAYER IS PROVIDED IN THE AI SENSOR ITSELF, filter all objects accordingg to layer then populate the characters array
